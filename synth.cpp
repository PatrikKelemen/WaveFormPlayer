...
public:
	bool OnUserCreate() override
	{
		...
		sample1.LoadAudioWaveform("./assets/sine.wav");
	...
	bool OnUserUpdate(float fElapsedTime) override
	{
		...
		{
			osc1.frequency.value *= pow(1.05946,1) ;
		}
		...
		{
			osc1.frequency.value =1/ 20000.0;
			osc2.frequency.value =1/ 20000.0;
			osc3.frequency.value =1/ 20000.0;
