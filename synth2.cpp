...
public:
	...
	custom_wave2 = olc::sound::Wave(1, sizeof(uint8_t), 44100, 44100);
		...
		keyButtons = {
            {olc::Key::E, "E", 3, {20, 60}},
            {olc::Key::K4, "4", 4, {40, 20}},
            {olc::Key::R, "R", 5, {60, 60}},
            {olc::Key::K5, "5", 6, {80, 20}},
            {olc::Key::T, "T", 7, {100, 60}},
            {olc::Key::S, "S", 8, {140, 60}},
            {olc::Key::X, "X", 9, {160, 20}},
            {olc::Key::D, "D",10, {180, 60}},
            {olc::Key::C, "C",11, {200, 20}},
            {olc::Key::F, "F",12, {220, 60}},
            {olc::Key::V, "V",13, {240, 20}},
            {olc::Key::G, "G",14, {260, 60}},
            {olc::Key::Y, "Y",15, {20, 140}},
            {olc::Key::K7, "7",16, {40, 100}},
            {olc::Key::U, "U",17, {60, 140}},
            {olc::Key::K8, "8",18, {80, 100}},
            {olc::Key::I, "I",19, {100, 140}},
            {olc::Key::H, "H",20, {140, 140}},
            {olc::Key::N, "N",21, {160, 100}},
            {olc::Key::J, "J",22, {180, 140}},
            {olc::Key::M, "M",23, {200, 100}},
            {olc::Key::K, "K",24, {220, 140}},
            {olc::Key::COMMA, ",",25,{240, 100}},
            {olc::Key::L, "L",26, {260, 140}}
        };
	...
	bool OnUserUpdate(float fElapsedTime) override
	{
        ...
        for (const auto& btn : keyButtons) {
            ...
            if (GetKey(btn.key).bPressed) {
                engine.PlayWaveform(&wavelist[btn.waveformIndex]);  // <-- You must define 'engine' and 'wavelist'
            }
        }
